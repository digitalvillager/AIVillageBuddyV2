...
export default function Home() {
      ...
      if (savedSessionId) {
        ...
        try {
          const response = await fetch(
            `/api/messages?sessionId=${savedSessionId}`,
          );
          if (response.ok) {
            ...
            if (
              ...
              console.log(
                "No messages found for saved session, starting fresh",
              );
            ...
            console.error(
              "Error fetching messages for saved session, starting fresh",
            );
            localStorage.removeItem("sessionId");
            await createNewSession();
          }
    ...
    const createNewSession = async () => {
      ...
      try {
        ...
        const response = await apiRequest("POST", "/api/messages", {
          ...
          role: "assistant",
          content:
            "Hello! I'm your AI Buddy from Digital Village. I'm here to help you refine your AI solution idea for your business.\n\nChoose a starting point or type your own question:",
        });
        ...
        toast({
          title: "Error",
          description:
            "Failed to initialize session. Please try refreshing the page.",
          variant: "destructive",
        });
      }
    };
    ...
    onSuccess: (data) => {
      ...
      if (data.message) {
        ...
        toast({
          title: "Warning",
          description:
            "Received an incomplete response from the AI. Some data may be missing.",
          variant: "default",
        });
      }
      ...
      if (isNewSession) {
        ...
        try {
          const messagesResponse = await fetch(
            `/api/messages?sessionId=${sessionToLoad}`,
          );
  ...
  if (
    isLoadingProjects ||
    (!sessionId && (isLoadingMessages || isLoadingSession))
  ) {
    return (
          ...
          <Card className="max-w-2xl w-full">
            <CardHeader>
              <CardTitle className="text-2xl font-bold">
                Welcome to Digital Village AI Buddy
              </CardTitle>
              <CardDescription>
                Create your first project to start exploring AI solutions for
                your business
              </CardDescription>
            </CardHeader>
      ...
      <div className="min-h-screen flex flex-col bg-bg-light-blue">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
            ...
            <p className="mb-4">
              We encountered an error loading your AI Buddy. Please try
              reloading the page.
            </p>
            <button
